      ...
      <div className="framer-57vhg3 layout-content-wide">
        <div className="framer-yagov1 corner-squircle">
          <div className="grid gap-3 sm:gap-4 md:grid-cols-2 xl:grid-cols-12 xl:[grid-template-rows:repeat(3,minmax(0,300px))] xl:auto-rows-[300px] xl:items-stretch">
            {hasSatisfaction ? (
              <article className="about-mosaic-panel about-mosaic-reveal corner-squircle min-h-[214px] rounded-[14px] p-4 sm:p-5 md:min-h-[248px] xl:col-span-3 xl:h-full">
            ...
            {hasStrategy ? (
              <article className="about-mosaic-panel about-mosaic-reveal corner-squircle min-h-[214px] overflow-hidden rounded-[14px] md:min-h-[248px] xl:col-span-9 xl:h-full" style={{ animationDelay: '60ms' }}>
            ...
            {hasConsultation ? (
              <article
                className="about-mosaic-panel about-mosaic-reveal corner-squircle relative min-h-[270px] overflow-hidden rounded-[14px] p-5 sm:min-h-[262px] sm:p-6 md:p-7 xl:col-span-6 xl:h-full"
            ...
            {hasPerformance ? (
              <article className="about-mosaic-panel about-mosaic-reveal corner-squircle min-h-[250px] rounded-[14px] p-5 sm:min-h-[262px] sm:p-6 md:p-7 xl:col-span-6 xl:h-full" style={{ animationDelay: '140ms' }}>
            ...
            {hasCaseStudy ? (
              caseStudyLink ? (
                <a
                  ...
                  className="about-mosaic-panel about-mosaic-case about-mosaic-reveal corner-squircle flex min-h-[208px] flex-col overflow-hidden rounded-[14px] p-4 xl:col-span-3 xl:h-full"
                ...
                <article className="about-mosaic-panel about-mosaic-case about-mosaic-reveal corner-squircle flex min-h-[208px] flex-col overflow-hidden rounded-[14px] p-4 xl:col-span-3 xl:h-full" style={{ animationDelay: '180ms' }}>
                  <div>
                    {caseStudyHeadline ? <p className="text-balance text-[1.16rem] sm:text-[1.42rem] font-medium leading-[1.08] tracking-[-0.04em] text-[#111111]">{caseStudyHeadline}</p> : null}
                    {caseStudyResult ? <p className="mt-2 text-sm text-[#69686e]">{caseStudyResult}</p> : null}
                  </div>
            ...
            {hasIndustries ? (
              <article className="about-mosaic-panel about-mosaic-reveal corner-squircle flex min-h-[208px] flex-col rounded-[14px] p-4 xl:col-span-6 xl:h-full" style={{ animationDelay: '220ms' }}>
            ...
            {hasTestimonial ? (
              <article className="about-mosaic-panel about-mosaic-reveal corner-squircle relative min-h-[208px] overflow-hidden rounded-[14px] xl:col-span-3 xl:h-full" style={{ animationDelay: '260ms' }}>
