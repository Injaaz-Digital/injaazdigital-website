...
export default function TrustRowBlock({ block }) {
  ...
  return (
    <section className="section section--tight">
      <div className="grid gap-[13px] rounded-[22px] border border-[rgba(8,66,153,0.12)] bg-white p-[21px] shadow-[0_10px_24px_rgba(8,41,89,0.05)] sm:grid-cols-2 lg:grid-cols-4">
        {items.map((item, index) => (
          <article key={`${item.title}-${index}`} className="rounded-[16px] border border-[rgba(8,66,153,0.08)] bg-[#f8fbff] px-[13px] py-[13px]">
