...
const LiquidEther = dynamic(() => import('./LiquidEther').then((m) => ({ default: m.default || m })), {
  ssr: false,
});

export default function HeroAtmosphere({ enableSimulation = true }) {
  return (
