...
export default function VipPlayingCube() {
  ...
  useEffect(() => {
    ...
    const environmentMap = createStudioEnvironment(renderer);
    ...
    const updateActivity = () => {
      const nextActive = intersectsViewport && !document.hidden;
      active = nextActive;
